              ...
              <View>
                ...
                <View style={surveyStyles.surveyBtnsContainer}>
                  <ResuableButton
                    ...
                    backgroundColor={
                      selected.q1NG ? COLORS.primary : COLORS.white
                    }
                    borderColor={
                      selected.q1NG ? COLORS.primary : COLORS.black400
                    }
                    borderRadius={10}
                    borderWidth={1}
                    btnText="Nigeria (NG)"
                    onPress={() =>
                      setSelected({...selected, q1NG: !selected.q1NG})
                    }
                  ...
                  <ResuableButton
                    alignItems="flex-start"
                    backgroundColor={
                      selected.q1ET ? COLORS.primary : COLORS.white
                    }
                    borderColor={
                      selected.q1ET ? COLORS.primary : COLORS.black400
                    }
                    borderRadius={10}
                    borderWidth={1}
                    btnText="Ethiopia (ET)"
                    onPress={() =>
                      setSelected({...selected, q1ET: !selected.q1ET})
                    }
                    paddingHorizantal={24}
                    paddingVertical={13}
                    size={16}
                  ...
                  <ResuableButton
                    alignItems="flex-start"
                    backgroundColor={
                      selected.q1TG ? COLORS.primary : COLORS.white
                    }
                    borderColor={
                      selected.q1TG ? COLORS.primary : COLORS.black400
                    }
                    borderRadius={10}
                    borderWidth={1}
                    btnText="Togo (TG)"
                    onPress={() =>
                      setSelected({...selected, q1TG: !selected.q1TG})
                    }
                    paddingHorizantal={24}
                    paddingVertical={13}
                    size={16}
                  ...
                  <ResuableButton
                    alignItems="flex-start"
                    backgroundColor={
                      selected.q1ZA ? COLORS.primary : COLORS.white
                    }
                    borderColor={
                      selected.q1ZA ? COLORS.primary : COLORS.black400
                    }
                    borderRadius={10}
                    borderWidth={1}
                    btnText="South Africa (ZA)"
                    onPress={() =>
                      setSelected({...selected, q1ZA: !selected.q1ZA})
                    }
                    paddingHorizantal={24}
                    paddingVertical={13}
                    size={16}
                  ...
                  <ResuableButton
                    alignItems="flex-start"
                    backgroundColor={
                      selected.q1GH ? COLORS.primary : COLORS.white
                    }
                    borderColor={
                      selected.q1GH ? COLORS.primary : COLORS.black400
                    }
                    borderRadius={10}
                    borderWidth={1}
                    btnText="Ghana (GH)"
                    onPress={() =>
                      setSelected({...selected, q1GH: !selected.q1GH})
                    }
                    paddingHorizantal={24}
                    paddingVertical={13}
                    size={16}
                  ...
                  onPress={() => {
                    if (disabled) {
                      Toast.show({
                        type: 'error',
                        text1:
                          'Please select at least ONE option before proceding',
